  ...
  return (
    <div>
      ...
      <div className="mx-auto w-[94%] lg:w-[80%]">
        ...
        bertoo.pro is committed to respecting the intellectual property
        ...
        <p className="mt-4 text-[#bdbdbd]">
          None of the files listed on bertoo.pro are hosted on our servers. All
          ...
          to{" "}
          <Link href="mailto:contact@cuynime.com" className="text-white">
            contact@cuynime.com
          </Link>{" "}
